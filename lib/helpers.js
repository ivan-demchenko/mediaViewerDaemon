...
exports.logInfo = ramda_1.curryN(2, logger_1.logger.info);
exports.logError = ramda_1.curryN(2, logger_1.logger.error);
...
exports.cachedCopyExists = ramda_1.curry(function (type, src) {
    var cacheFilePath = exports.cachePath(type, src);
    exports.logInfo('cachedCopyExists: ' + cacheFilePath);
    return Future.node(function (done) {
        return fs.access(cacheFilePath, fs.constants.F_OK, done);
